...
def generate_experience_pack(
    pack_id, pack_name, task, creator_name, creator_id, experience_class, sparql_query
):
    # Fetching results
    ...
    for result in results:
        entity = {
            ...
            "global_id": f"{pack_id}_{str(len(entities) + 1)}",
        }
    ...
    experience_pack = {"entities": entities, "pack": pack}
...
def main():
  ...
  """
    ...
    experience_pack = generate_experience_pack(
        pack_id="naked_eye_planets",
